...
RTB_REGISTER_COMPONENT(PlayerMeleeSweepAttackAbility)
    RTB_PROPERTY_SERIALIZED(attackOriginOffset)
    RTB_PROPERTY_SERIALIZED_RANGE(cooldown, 0.0f, 10.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(damage, 0.0f, 1000.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(hitDelay, 0.0f, 10.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(recoveryDuration, 0.0f, 10.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(sphereRadius, 0.05f, 5.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(sphereDistance, 0.05f, 10.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(tickInterval, 0.0f, 2.0f)
    RTB_PROPERTY_SERIALIZED_RANGE(tickCount, 1, 8)
    RTB_PROPERTY_SERIALIZED_RANGE(knockbackStrength, 0.0f, 20.0f)
