...
RTB_REGISTER_DATA_ASSET(CharacterDefinition)
    ...
    RTB_PROPERTY_RANGE(projectileBurstInterval, 0.0f, 2.0f)
    RTB_PROPERTY_RANGE(projectileBurstCount, 1, 8)
    ...
    RTB_PROPERTY_RANGE(meleeTickInterval, 0.0f, 2.0f)
    RTB_PROPERTY_RANGE(meleeTickCount, 1, 8)
    RTB_PROPERTY_RANGE(meleeKnockback, 0.0f, 20.0f)
    RTB_PROPERTY_RANGE(projectileKnockback, 0.0f, 20.0f)
