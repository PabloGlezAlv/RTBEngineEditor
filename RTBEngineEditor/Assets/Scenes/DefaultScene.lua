    ...
    return {
        ...
        gameObjects = {
            ...
            },
            {
                ...
                collisionLayer = "Characters",
                prefab = "Player Knight",
                position = Vector3(0.90, 0.10, 0.00),
                overrides = {
                    components = {
                        { type = "CharacterStatsApplier",
                            usePlayerSelection = false,
                            characterDefinitionRef = "Assets/Data/Characters/Knight.rtbasset",
                        },
                        { type = "ThirdPersonCharacterController",
                            ...
                            attackAbility = "F86013BD-FF24-4672-91B3-9411CDF272AE/PlayerMeleeSweepAttackAbility",
