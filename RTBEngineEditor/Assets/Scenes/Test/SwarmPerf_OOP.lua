function CreateScene()
    return {
        ...
        gameObjects = {
            {
                name = "Main Camera",
                uuid = "TPERF-OOP-CAM1-4000-8000-000000000001",
            ...
            },
            {
                ...
                uuid = "TPERF-OOP-LIT1-4000-8000-000000000002",
            ...
            {
                name = "Ground",
                uuid = "TPERF-OOP-GRD1-4000-8000-000000000003",
                rotation = Quaternion.FromEulerAngles(0.00, 0.00, 180.00),
            ...
            {
                name = "PerfBenchmark",
                uuid = "TPERF-OOP-BNCH-4000-8000-000000000004",
                components = {
                    {
            ...
            {
                name = "Canvas",
                uuid = "TPERF-OOP-CVS1-4000-8000-000000000005",
                components = {
                    {
                        type = "Canvas",
                ...
                children = {
                    {
                        name = "PerfStatusText",
                        uuid = "TPERF-OOP-TXT1-4000-8000-000000000006",
                        components = {
                            {
                                type = "UIText",
                                text = "MODE: OOP\nSpawning...",
                                color = Color(0.95, 0.96, 0.98, 1.00),
                                fontSize = 22.00,
                                alignment = "Left",
                                font = nil,
                                isVisible = true,
                                ...
                                anchoredPosition = Vector2(24.00, -228.00),
                    ...
                    {
                        name = "TitleText",
                        uuid = "TPERF-OOP-TTL1-4000-8000-000000000007",
                        components = {
                            {
                                type = "UIText",
                                text = "Swarm Perf — OOP (virtual OnUpdate)",
                                color = Color(1.00, 0.72, 0.35, 1.00),
                                fontSize = 26.00,
                                alignment = "Center",
                                font = nil,
                                isVisible = true,
